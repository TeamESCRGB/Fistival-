...
namespace UI.Popup
{
    public class ShopUI : UIPopupBase
    {
        ...
        public override bool Init()
        {
            ...
            Managers.Instance.GlobalSoundManager.Play(SoundChannel.BGM_0, "ShopBGM", true);
            Managers.Instance.GlobalSoundManager.Play(SoundChannel.EFFECT_0, "ShopEnterSFX", false);
        ...
        private void UpdateItemData()
        {
            ...
            Managers.Instance.GlobalSoundManager.Play(SoundChannel.EFFECT_0, "OnShopItemSelectedSFX", false);
        ...
        private void OnExitButton(PointerEventData _)
        {
            ...
            Managers.Instance.GlobalSoundManager.Play(SoundChannel.EFFECT_0, "ShopExitSFX", false);
        }
        ...
        private void OnPurchase(PointerEventData _)
        {
            ...
            Managers.Instance.GlobalSoundManager.Play(SoundChannel.EFFECT_0, "OnPurchaseSFX", false);
            UpdateItemData();
        }
