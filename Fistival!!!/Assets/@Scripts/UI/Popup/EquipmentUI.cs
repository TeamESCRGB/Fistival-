...
namespace UI.Popup
{
    public class EquipmentUI : UIPopupBase
    {
        ...
        private void OnEquipmentSlotClicked(PointerEventData data)
        {
            ...
            {
                Managers.Instance.GlobalSoundManager.Play(Defines.SoundChannel.EFFECT_0, "FailedSFX", false);
                return;
            }
            ...
            Managers.Instance.GlobalSoundManager.Play(Defines.SoundChannel.EFFECT_0, comp.GetData().UnEquipSound, false);
        ...
        private void OnItemClicked(PointerEventData data)
        {
            ...
            if (_player != null)
            {
                Managers.Instance.GlobalSoundManager.Play(Defines.SoundChannel.EFFECT_0, item.EquipSound, false);
