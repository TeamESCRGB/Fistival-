...
namespace Coordinator.Mobs
{
    public class FlyingDIscThrowMob : MobCoordinatorBase, IPushable
    {
        ...
        public override void Init(CommonMobData data)
        {
            ...
            _act.Init(() => { _isActing = false; }, _objKey, _objIdx, _damage, _stunTime, _returnDuration,  _movLen * Mathf.Sign(transform.right.x), _objectizableLayer);//소환하는것들 인자에 보는 방향 넣어주도록 수정하기
        }
