...
namespace Coordinator.Modes
{
    public class FistivalMode : ModeBase
    {
        ...
        public override void Init(CommonModeData data)
        {
            ...
            _hand.Init(GetComponentInParent<Rigidbody2D>(), _playerData.Damage,_playerData.StrongAttackDamage ,_playerData.AttackableLayers, _playerData.PickableLayers, _playerData.ForcePerCharge, _playerData.ChargeTimeInterval, _playerData.AttackCooldown);//아니 이거 데이터에 추가해야되네
